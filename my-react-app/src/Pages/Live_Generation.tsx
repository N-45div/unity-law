...
const Live_Generation = () => {
  ...
  const getClauseForQuestion = (question: string, questionClauseMap: { [key: string]: string }, userAnswers: { [key: string]: string | boolean }): string => {
    ...
    // Handle small condition clause
    if (question === smallConditionQuestion) {
      const answer = userAnswers[smallConditionQuestion] || false;
      return getUpdatedClause(questionClauseMap[smallConditionQuestion] || smallConditionClause, "", answer);
    }
